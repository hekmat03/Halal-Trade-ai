...
class RiskAccount:
    ...
    # Realized P&L for the current day (USDT).
    realized_pnl_today: Optional[float] = None

    # Set by a DrawdownLockout once a max-drawdown breach has occurred.
    trading_locked: bool = False
    trading_locked_reason: Optional[str] = None
...
class Context:
    ...
    # Whether order status has been confirmed from the source of truth.
